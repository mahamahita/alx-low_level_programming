 ...
 * @e_ident: pointer to the array containing ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 * @e_ident:  pointer to the array containing ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
 ...
 * @e_ident:  pointer to the array containing the version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_ident:  pointer to the  array containing the ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_type:  ELF type.
 * @e_ident: pointer to the  array containing the class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
